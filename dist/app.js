...
/*!*******************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./src/Main.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************/
...
function () {
  function Converter(source) {
    ...
    this.elementConverters = {
      ...
      'A': {
        type: 'inline',
        converter: 'convertLinkOrAnchor'
      },
      'STRONG': {
        type: 'inline',
        converter: 'convertStrong'
      },
      'B': {
        type: 'inline',
        converter: 'convertStrong'
      ...
      'PRE': {
        type: 'block',
        converter: 'convertPre'
      },
      'BLOCKQUOTE': {
        type: 'block',
        converter: 'convertBlockQuote'
      },
      'UL': {
        type: 'block',
      ...
      'LI': {
        type: 'block',
        converter: 'convertListItem'
      },
      'H1': {
        type: 'block',
        converter: 'convertHeading'
      },
      'H2': {
        type: 'block',
        converter: 'convertHeading'
  ...
  _createClass(Converter, [{
    ...
    key: "convertChildren",
    value: function convertChildren(div) {
      var _this = this;

      var childContent = '';
      [].forEach.call(div.childNodes, function (el, index, parent) {
        var t = el.nodeName;
        var converter = _this.elementConverters[t] || {
          type: 'block',
          converter: 'convertContent'
        };
        ...
        var result = _this[converter.converter](el);
    ...
    key: "convertCode",
    value: function convertCode(el) {
      var content = this.convertChildren(el);
    ...
    key: "convertPara",
    value: function convertPara(el) {
      return this.convertChildren(el).replace(/\n+$/, '') + "\n\n";
    }
  }, {
    key: "convertPre",
    value: function convertPre(el) {
      return '\n```\n' + this.convertChildren(el).replace(/\n+$/, '') + '\n```\n\n';
    }
  }, {
    key: "convertBlockQuote",
    value: function convertBlockQuote(el) {
      var content = this.convertChildren(el).replace(/\n+$/, '');
      return content.replace(/^/mg, '> ');
    }
  }, {
    key: "convertLinkOrAnchor",
    value: function convertLinkOrAnchor(el) {
      if (el.hasAttribute('href')) {
        // Link
        var href = el.getAttribute('href');
        var title = el.getAttribute('title');
        var content = this.convertChildren(el);
        return title ? "[".concat(content, "](").concat(href, " \"").concat(title, "\")") : "[".concat(content, "](").concat(href, ")");
      } else {
        // Anchor.
    ...
    key: "convertContent",
    value: function convertContent(el) {
      console.log("Unhandled tag: ", el);
      return this.convertChildren(el) + "\n\n";
    }
  }, {
    key: "convertList",
    value: function convertList(el) {
      return this.convertChildren(el);
    }
  }, {
    key: "convertListItem",
    value: function convertListItem(el) {
    ...
    key: "convertHeading",
    value: function convertHeading(el) {
      return '#'.repeat(el.nodeName[1]) + ' ' + this.convertChildren(el).replace(/\n+$/, '') + '\n\n';
    }
  }, {
    key: "convertBr",
    value: function convertBr(el) {
      return '  \n';
    }
  }, {
    key: "convertStrong",
    value: function convertStrong(el) {
      return '**' + this.convertChildren(el) + '**';
    }
  }, {
    key: "converteEmphasis",
    value: function converteEmphasis(el) {
      return '*' + this.convertChildren(el) + '*';
    }
  }, {
    key: "parentStackNodeName",
    value: function parentStackNodeName() {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/Main.vue?vue&type=template&id=3ffae6b2&":
/*!***********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/Main.vue?vue&type=template&id=3ffae6b2& ***!
  \***********************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c("div", { staticClass: "tomd" }, [
    _c("div", { staticClass: "tomd__input" }, [
      _c("label", [
        _vm._v("Paste in HTML. You can paste markup or formatted HTML\n    "),
        _c("textarea", {
          directives: [
            {
              name: "model",
    ...
    _vm._v(" "),
    _c("div", { staticClass: "tomd__output" }, [
      _c("label", [
        _vm._v("MarkDown\n    "),
        _c("textarea", {
          directives: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Main_vue_vue_type_template_id_3ffae6b2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../node_modules/vue-loader/lib??vue-loader-options!./Main.vue?vue&type=template&id=3ffae6b2& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/Main.vue?vue&type=template&id=3ffae6b2&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Main_vue_vue_type_template_id_3ffae6b2___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Main_vue_vue_type_template_id_3ffae6b2___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! /home/rich/tomd/src/app.js */"./src/app.js");
module.exports = __webpack_require__(/*! /home/rich/tomd/src/app.scss */"./src/app.scss");
